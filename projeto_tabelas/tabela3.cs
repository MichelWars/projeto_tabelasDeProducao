...
{
    public partial class tabela3 : Form
    {
        public tabela3()
        {
            InitializeComponent();
        ...
        private void buttonCalcular_Click_1(object sender, EventArgs e)
        {
            ...
            {
                textMeta1.Text = radioRef1.Checked ? "0" : (35 * Convert.ToDouble(textVelocPlan.Text)).ToString();
                ...
                textMeta8.Text = radioRef8.Checked ? textMeta7.Text : (50 * Convert.ToDouble(textVelocPlan.Text) + Convert.ToDouble(textMeta7.Text)).ToString();
        ...
        // Ajustar o GroupBox no centro da tela
        ...
        private void radioRef8_CheckedChanged(object sender, EventArgs e)
        {
            habilitar();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string sql =
          $"INSERT INTO periodo_noite (data, equipamento, horario, meta_unidades, acumulado_unidades,parada_minutos,observacao) " +
            ...
            $"VALUES ('{data}', '{equipamento}', '{horario[7]}', '{meta[7]}', '{acumulado[7]}', '{parada[7]}', '{observacao[7]}');" +//linha8
             ...
             $"INSERT INTO relatorio_noite (data, equipamento, dispProd, velocMediaPlan, prodReal, totalParada, velocMediaReal, perdasQuali, percent1, percent2, percent3, oee) " +
